...
routerDOM.Link = function (props) { return <a>{props.children}</a>; };
...
var Component = function () { return (<react_redux_1.Provider store={store_1.store}>
    <Project_1.default location={location} match={match}/>
...
describe('Project Component Integration Test', function () {
    test('Project Component Renders', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            component = react_testing_library_1.render(<Component />);
            return [2 /*return*/];
        });
    }); });
