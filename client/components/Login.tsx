...
class Login extends React.Component<Props, State> {
  ...
  handleEmailChange = (event: React.MouseEvent<HTMLInputElement>) => {
    this.setState({ email: event.currentTarget.value });
  };

  handleForgotEmailChange = (event: React.MouseEvent<HTMLInputElement>) => {
    this.setState({ forgotEmail: event.currentTarget.value });
  };

  handlePasswordChange = (event: React.MouseEvent<HTMLInputElement>) => {
