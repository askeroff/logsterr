...
var DatePicker = /** @class */ (function (_super) {
    ...
    DatePicker.prototype.render = function () {
        ...
        <select className="dashboard__select" onChange={this.changeData} value={this.props.defaultShow}>
          <option value="lastweek">Last Week</option>
          <option value="thisweek">This Week</option>
          <option value="today">Today</option>
          <option value="month">This Month</option>
        </select>
        <react_dates_1.DateRangePicker startDate={this.props.startDate} displayFormat="DD/MM/YYYY" startDateId="your_unique_start_date_id" endDate={this.props.endDate} endDateId="your_unique_end_date_id" onDatesChange={this.onDatesChange} firstDayOfWeek={1} minimumNights={0} isOutsideRange={function () { return false; }} focusedInput={this.props.focusedInput} onFocusChange={function (focusedInput) {
            return _this.props.setFocusedInput(focusedInput);
        }}/>
